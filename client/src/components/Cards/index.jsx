        ...
        <article>
          <div className={styles.article_wrapper}>
            ...
            <div className={styles.article_body}>
              <h2>This is some title</h2>
              <p>
                Curabitur convallis ac quam vitae Nulla mauris ante, euismod sed lacus sit amet, congue bibendum eros. Etiam mattis lobortis porta. Vestibulum ultrices iaculis enim imperdiet egestas.
        </p>
        <a href="/" className={styles.read_more}>
          Read more <span className={styles.sr_only}>about this is some title</span>
          <svg xmlns="http://www.w3.org/2000/svg" className={styles.icon} viewBox="0 0 20 20" fill="currentColor">
